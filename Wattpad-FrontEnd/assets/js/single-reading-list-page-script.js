...
async function loadAllStoriesInReadingList() {
    ...
    await fetch('http://localhost:8080/api/v1/readingList/single/all/'+readingListId, {
        method: 'GET',
        credentials: 'include',
        headers: {
            'Content-Type': 'application/json'
            ...
            L1: for (let i = 0; i < readingList.readingListEditStoryDTOList.length; i++) {
                ...
                <div class="hMjEl">
                    <div class="sjEcX">
                        ...
                        <!--story description,static side-->
                        <div class="pyTju">
                            <!--story title-->
                            <a class="HsS0N" href="http://localhost:63342/Wattpad-Clone/Wattpad-FrontEnd/story-overview-page.html?storyId=${story.storyId}">
                                <div class="MF8XD">${story.storyTitle}️</div>
                            </a>
                            <!--author name-->
                            <a class="HsS0N" href="http://localhost:63342/Wattpad-Clone/Wattpad-FrontEnd/user-profile.html?userId=${story.userId}">
                                <div class="CS12a">${story.username}</div>
                            </a>
                            <!--story static-->
                            <div class="zxDQP" data-testid="story-stats">
                                <ul class="n0iXe bheBj">
                                    <li class="_0jt-y ViutA">
                                        ...
                                        <span class="sr-only">Reads 1,541,666</span>
                                        <div class="stats-value">
                                            <div aria-hidden="true" data-testid="stats-value-container">
                                                <span class="sr-only">1,541,666</span>
                                    ...
                                    <li class="_0jt-y ViutA">
                                        ...
                                        <div class="stats-value">
                                            <div aria-hidden="true" data-testid="stats-value-container">
                                                ...
                                                <span class="_5TZHL cBfL0" aria-hidden="true" data-testid="stats-value">${story.parts}</span>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <!--story description-->
                            <div class="RHuBB">${story.storyDescription}</div>
                            <!--tags-->
                            <div class="-pwvK">
                                <div class="-GazY" data-testid="tag-meta">
                                    ...
                                    ${tagLess <= 0
                                    ? ``
                                    : `<span class="Oo0fc xQ7tD">+${tagLess} more</span>`
                                    }
                                </div>
                            </div>
                        </div>
                ...
                $('#reading-list-stories-container').append(singleStory);
            }
...
$(document).on('click','#delete-btn',function (event) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            await fetch('http://localhost:8080/api/v1/readingList/'+readingListId, {
                method: 'DELETE',
                credentials: 'include',
                headers: {
                    'Content-Type': 'application/json'
                ...
                .then(data => {
                    console.log('Success:', data);
                    window.location.href = `http://localhost:63342/Wattpad-Clone/Wattpad-FrontEnd/reading-list-page.html`;
