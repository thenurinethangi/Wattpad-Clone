...
//            }
    ...
    public List<SearchProfileReturnDTO> getAllProfilesThatMatchToSearchedKeyWord(String username,String input) {
        ...
        try{
            ...
            for (User x : finalSelectedUserList){
                ...
                searchProfileReturnDTO.setStoryCount(publishedCount);
                ...
                for (Following y : followingList) {
                    if (y.getFollowedUserId() == user.getId()) {
    ...
    @Override
    public SearchResponseDTO getAllStoriesThatMatchToSearchedKeyWordAndLimitedCount(String input, int count) {
        ...
        int lessCount = 0;
        if(genreStoryDTOList.size()<count){
            lessCount = count-genreStoryDTOList.size();
        }
        ...
        int i = 0;
        L1:while (genreStoryDTOList.size()<count){
